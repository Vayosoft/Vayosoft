...
#pragma warning restore S2743 // Static fields should not be used in generic types
        ...
        public static IChangeToken CreateChangeTokenForKey(string key)
        {
            ...
            EnsureGlobalTokenCallbackRegistered();
        ...
        private static void EnsureGlobalTokenCallbackRegistered()
        {
            if (_globalTokenDisposable == null)
            {
                lock (_lock)
                {
                    if (_globalTokenDisposable == null)
                    {
                        _globalTokenDisposable = GlobalTokenSource.Token.Register(state =>
                        {
